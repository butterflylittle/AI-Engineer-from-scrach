...
| `15-deepagent` | LangChain Deep Agents 快速入门：工具、子 Agent 与文件系统 |
| `99-My idea` | 个人笔记与扩展思考 |

## 学习路径

基础概念 → Prompt / 工具调用 → RAG → 记忆 → 多智能体 → 模型路由 → Harness → 大模型基础 → **开源 Agent 源码（Hermes / waku / Pi）** → Loop Engineering → CI/CD → LangGraph → Deep Agents。
...
- Deep Agents 教程与示例见 `15-deepagent/README.md`。
